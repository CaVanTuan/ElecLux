    ...
    public partial class suaDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalPlans", x => x.PlanId);
                    table.ForeignKey(
                        name: "FK_RentalPlans_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_RentalPlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    PromoId = table.Column<int>(type: "int", nullable: false),
                    BookingPromotionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingPromotions", x => new { x.BookingId, x.PromoId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingPromotions_Promotions_PromoId",
                        column: x => x.PromoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingPromotions_PromoId",
